...
insert into BALANCE_TABLE (user_id)
values (1);

insert into SEAT_TABLE (seat_no, concert_item_id, price, status, hold_expiry_time)
values (1, 1, 80000, 'EMPTY', DATEADD('DAY', 30, CURRENT_TIMESTAMP));
